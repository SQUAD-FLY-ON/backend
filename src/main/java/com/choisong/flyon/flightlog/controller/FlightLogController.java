...
public class FlightLogController {
    ...
    @Operation(summary = "내 비행 기록 목록 조회", description = "로그인한 사용자의 비행 기록 목록을 조회합니다.")
    @GetMapping("/me")
    public List<FlightLogResponse> getByMemberId(@AuthenticationMember Long memberId) {
        return flightLogService.getByMemberId(memberId);
    }
